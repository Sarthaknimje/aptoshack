  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] relative overflow-hidden">
      ...
      <main className="relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {[
                      ...
                      { value: 'image', label: 'Images', icon: ImageIcon, color: 'from-green-500 to-emerald-500' },
                      { value: 'video', label: 'Videos', icon: Video, color: 'from-red-500 to-pink-500' },
                      { value: 'reel', label: 'Reels', icon: Zap, color: 'from-amber-500 to-orange-500' },
                      { value: 'audio', label: 'Audio', icon: Music, color: 'from-purple-500 to-pink-500' }
        ...
        {/* Feed Content */}
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-20" ref={feedRef}>
          {loading ? (
