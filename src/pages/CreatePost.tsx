      ...
      <main className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {coinCreated && createdCoinData ? (
          ...
          >
            ...
            <p className="text-gray-400 mb-8 max-w-md mx-auto">
              Your creator coin is now live on the Aptos blockchain! Start trading and monetize your content.
            </p>
            
            <div className="grid grid-cols-2 gap-4 mb-8 max-w-xl mx-auto">
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                <Coins className="w-6 h-6 text-green-400 mx-auto mb-2" />
                <div className="text-sm font-semibold text-white">Total Supply</div>
                <div className="text-xs text-gray-400">1,000,000 tokens</div>
              </div>
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                <TrendingUp className="w-6 h-6 text-emerald-400 mx-auto mb-2" />
                <div className="text-sm font-semibold text-white">Ready to Trade</div>
                <div className="text-xs text-gray-400">Available in marketplace</div>
              </div>
            </div>
